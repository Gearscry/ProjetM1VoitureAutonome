...
flags.DEFINE_integer("num_tfrecords_shards", 20,
                     "Number of shards for trainv2/valid/testv2.")
...
def transform_as_tfrecords(data_processor, filename):
  ...
  Args:
    ...
    filename: 'trainv2', 'valid', or 'testv2'.
  """
...
def main(_):
  ...
  print()
  transform_as_tfrecords(data_processor, "trainv2")
  transform_as_tfrecords(data_processor, "valid")
  transform_as_tfrecords(data_processor, "testv2")
