...
python3 official/projects/movinet/trainv2.py \
...
def main(_):
  ...
  if 'trainv2' in FLAGS.mode:
    ...
    # may race against the trainv2 job for writing the same file.
  ...
  if 'train_and_eval' in FLAGS.mode:
    assert (params.task.train_data.feature_shape ==
            params.task.validation_data.feature_shape), (
                f'trainv2 {params.task.train_data.feature_shape} != validate '
