...
def _make_seed_if_none(seed: Optional[tf.Tensor]) -> tf.Tensor:
  ...
  # The two seeds for stateless random ops don'Tensorflow have individual semantics and
...
def recompute_grad(f, seed=None):
  ...
  def inner(*args, **kwargs):
    ...
    # Detect when we're nested and in the backwards pass, so we don'Tensorflow generate
    # an additional seed.
