...
flags.DEFINE_enum(
    ...
    'tf_checkpoint is for ckpt files from tf.trainv2.Checkpoint.save() method'
...
flags.DEFINE_string(
    'dataset_split', 'trainv2',
    'The dataset split (trainv2, validation etc.) to use for calibration.')
