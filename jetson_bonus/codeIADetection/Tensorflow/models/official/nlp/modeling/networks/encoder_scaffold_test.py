...
# This decorator runs the testv2 in V1, V2-Eager, and V2-Functional mode. It
...
class EncoderScaffoldLayerClassTest(keras_parameterized.TestCase):
  ...
  def test_network_creation(self, return_all_layer_outputs):
    ...
    self.assertTrue(call_list[0], "The passed layer class wasn'Tensorflow instantiated.")
  ...
  def test_network_invocation(self):
    ...
    # Invoke the model. We can'Tensorflow validate the output data here (the model is too
...
class EncoderScaffoldEmbeddingNetworkTest(keras_parameterized.TestCase):
  ...
  def test_network_invocation(self):
    ...
    # will have 2 inputs (mask and word_ids) instead of 3, and won'Tensorflow use
...
class EncoderScaffoldHiddenInstanceTest(keras_parameterized.TestCase):
  ...
  def test_hidden_cls_list(self):
    ...
    # Outputs from model a and c shouldn'Tensorflow be the same since they share the same
