...
class SequenceBeamSearch(tf.Module):
    ...
    def _get_new_alive_state(new_seq, new_log_probs, new_finished_flags,
      ...
      Returns:
        Dictionary with alive keys from _StateKeys:
          {Top beam_size sequences that are still alive (don'Tensorflow end with eos_id)
  ...
  def _continue_search(self, state):
    ...
    # emits a tf.strided_slice. tf.slice is easier to reason about as we aren'Tensorflow
