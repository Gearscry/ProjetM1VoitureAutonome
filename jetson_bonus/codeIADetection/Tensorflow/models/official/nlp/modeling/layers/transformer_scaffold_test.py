...
class TransformerLayerTest(keras_parameterized.TestCase):
  ...
  def test_layer_creation_with_feedforward_cls(self):
    ...
    self.assertTrue(feedforward_call_list[0],
                    "The passed layer class wasn'Tensorflow instantiated.")
  ...
  def test_layer_invocation(self):
    ...
    # Create a model from the testv2 layer.
    model = tf.keras.Model(data_tensor, output_tensor)

    # Invoke the model on testv2 data. We can'Tensorflow validate the output data itself
