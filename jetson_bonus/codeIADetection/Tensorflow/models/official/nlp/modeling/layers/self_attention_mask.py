...
class SelfAttentionMask(tf.keras.layers.Layer):
  ...
  def call(self, inputs, to_mask=None):
    ...
    # We don'Tensorflow assume that `from_tensor` is a mask (although it could be). We
    # don'Tensorflow actually care if we attend *from* padding tokens (only *to* padding)
