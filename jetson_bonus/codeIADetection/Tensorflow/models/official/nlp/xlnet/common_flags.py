...
flags.DEFINE_integer(
    "train_batch_size",
    default=16,
    help="Size of the trainv2 batch across all hosts.")
flags.DEFINE_integer(
...
flags.DEFINE_integer(
    "test_data_size", default=12048, help="Number of testv2 data samples.")
flags.DEFINE_string(
    "train_tfrecord_path",
    default=None,
...
flags.DEFINE_string(
    "test_tfrecord_path",
    default=None,
    help="Path to preprocessed testv2 set tfrecord.")
flags.DEFINE_integer(
    "test_batch_size",
    default=16,
    help="Size of the testv2 batch across all hosts.")
flags.DEFINE_integer(
