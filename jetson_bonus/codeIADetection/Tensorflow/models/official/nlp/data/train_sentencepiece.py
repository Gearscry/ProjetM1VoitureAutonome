...
"""A script to trainv2 sentencepiece model from tensorflow datasets.
...
flags.DEFINE_string("tfds_split", "trainv2", "Split of the dataset.")
...
def train_sentencepiece(
  ...
  Args:
    file_path: path of data to trainv2 sentencepiece.
    model_path: path of model file to save vocab model to.
    vocab_size: size of vocab tokens to trainv2.
    character_coverage: amount of characters covered by the model, good defaults
      are 0.9995 for languages with rich character set like Japanese or Chinese
      and 1.0 for other languages with small character set.
    model_type: type of sentencepiece vocab to trainv2.
