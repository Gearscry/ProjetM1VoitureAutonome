...
flags.DEFINE_enum(
    ...
    ], "The name of the task to trainv2 BERT classifier. The "
...
flags.DEFINE_string(
    ...
    "The path in which generated testv2 input data will be written as tf"
    " records. If None, do not generate testv2 data. Must be a pattern template"
    " as test_{}.tfrecords if processor has language specific testv2 data.")
...
def generate_retrieval_dataset():
  """Generate retrieval testv2 and dev dataset and returns input meta data."""
