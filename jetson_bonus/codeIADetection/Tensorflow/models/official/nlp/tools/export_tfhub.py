...
flags.DEFINE_string(
    ...
    "that can be restored to `tf.trainv2.Checkpoint(encoder=encoder)` "
    ...
    "`tf.trainv2.Checkpoint(**BertPretrainerV2(...).checkpoint_items)`. "
    "(For now, `tf.trainv2.Checkpoint(pretrainer=BertPretrainerV2(...))` is also "
    "accepted.)")
flags.DEFINE_string(
    "vocab_file", None,
