...
class BasicTokenizer(object):
  ...
  def tokenize(self, text):
    ...
    # models. This is also applied to the English models now, but it doesn'Tensorflow
    # matter since the English models were not trained on any Chinese data
    # and generally don'Tensorflow have any Chinese data in them (there are Chinese
