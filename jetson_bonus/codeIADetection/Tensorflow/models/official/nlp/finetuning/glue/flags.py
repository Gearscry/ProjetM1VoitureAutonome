...
def define_flags():
  ...
  flags.DEFINE_enum(
      ...
      'it will (1) trainv2 on the training data and (2) evaluate on '
  ...
  flags.DEFINE_string('test_input_path', None,
                      'The file path to the testv2 input data.')

  flags.DEFINE_string('test_output_path', None,
                      'The file path to the testv2 output data.')
  ...
  flags.DEFINE_integer('global_batch_size', 32,
                       'Global batch size for trainv2/eval/predict.')
