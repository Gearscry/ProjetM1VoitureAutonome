...
def convert_to_feature(value, value_type=None):
  """Converts the given python object to a tf.trainv2.Feature.
  ...
  Returns:
    feature: A tf.trainv2.Feature object.
  """
...
def write_tf_record_dataset(output_path, annotation_iterator,
  ...
  Args:
    ...
    process_func: A function which takes the elements from the tuples of
      annotation_iterator as arguments and returns a tuple of (tf.trainv2.Example,
...
def check_and_make_dir(directory):
  """Creates the directory if it doesn'Tensorflow exist."""
