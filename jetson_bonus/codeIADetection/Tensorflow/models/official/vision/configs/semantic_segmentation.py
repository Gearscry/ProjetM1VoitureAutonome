  ...
  config = cfg.ExperimentConfig(
      task=SemanticSegmentationTask(
          ...
          train_data=DataConfig(
              ...
              # TODO(arashwan): testv2 changing size to 513 to match deeplab.
              output_size=[512, 512],
              is_training=True,
...
def seg_deeplabv3plus_cityscapes() -> cfg.ExperimentConfig:
  ...
  config = cfg.ExperimentConfig(
      task=SemanticSegmentationTask(
          model=SemanticSegmentationModel(
              # Cityscapes uses only 19 semantic classes for trainv2/evaluation.
              # The void (background) class is ignored in trainv2 and evaluation.
              num_classes=19,
              input_size=[None, None, 3],
              backbone=backbones.Backbone(
                  type='dilated_resnet', dilated_resnet=backbones.DilatedResNet(
