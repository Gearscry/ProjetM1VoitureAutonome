...
"""A light weight utilities to trainv2 NLP models."""
...
def run_customized_training_loop(
  ...
  Args:
      ...
      steps_per_loop: Number of steps per graph-mode loop. In order to reduce
        ...
        steps_per_loop.
      epochs: Number of epochs to trainv2.
  ...
  if not steps_per_loop:
    if tf.config.list_logical_devices('TPU'):
      # One can'Tensorflow fully utilize a TPU with steps_per_loop=1, so in this case
  ...
  with distribute_utils.get_strategy_scope(strategy):
    ...
    def _run_evaluation(current_training_step, test_iterator):
      ...
      Args:
        ...
        test_iterator: distributed iterator of testv2 datasets.
