...
flags.DEFINE_enum(
    ...
    'restores the model to output predictions on the testv2 set.')
...
flags.DEFINE_integer('train_data_size', None, 'Number of training samples '
                     'to use. If None, uses the full trainv2 data. '
                     '(default: None).')
...
def run_bert_classifier(strategy,
  ...
  # tasks. The classification tasks, using the custom get_loss_fn don'Tensorflow accept
