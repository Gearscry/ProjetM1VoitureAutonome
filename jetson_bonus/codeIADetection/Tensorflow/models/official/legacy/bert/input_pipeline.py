...
def single_file_dataset(input_file, name_to_features, num_samples=None):
  ...
  # For eval, we want no shuffling and parallel reading doesn'Tensorflow matter.
...
def create_pretrain_dataset(input_patterns,
  ...
  # In parallel, create tf record dataset for each trainv2 files.
...
def create_classifier_dataset(file_path,
                              ...
                              num_samples=None):
  """Creates input dataset from (tf)records files for trainv2/eval."""
  name_to_features = {
