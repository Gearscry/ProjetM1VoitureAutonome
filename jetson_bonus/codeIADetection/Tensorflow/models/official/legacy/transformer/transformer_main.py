...
class TransformerTask(object):
  ...
  def train(self):
    ...
    while current_step < flags_obj.train_steps:
      ...
      logging.info(
          "Start trainv2 iteration at global step:{}".format(current_step))
      history = None
      if params["use_ctl"]:
        if not self.use_tpu:
      ...
      logging.info("End trainv2 iteration at global step:{}".format(current_step))
