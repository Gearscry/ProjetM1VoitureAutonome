...
# Number of files to split trainv2 and evaluation data
_TRAIN_SHARDS = 100
_EVAL_SHARDS = 1
...
def find_file(path, filename, max_depth=5):
  ...
  for root, dirs, files in os.walk(path):
    ...
    # Don'Tensorflow search past max_depth
...
def download_and_extract(path, url, input_filename, target_filename):
  ...
  # Download archive file if it doesn'Tensorflow already exist.
...
def main(unused_argv):
  ...
  # Download test_data
  logging.info("Step 1/5: Downloading testv2 data")
