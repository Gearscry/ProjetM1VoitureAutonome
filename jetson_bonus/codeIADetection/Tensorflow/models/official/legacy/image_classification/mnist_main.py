...
def run(flags_obj, datasets_override=None, strategy_override=None):
  ...
  Args:
    ...
    datasets_override: A pair of `tf.data.Dataset` objects to trainv2 the model,
                       representing the trainv2 and testv2 sets.
  ...
  num_train_examples = mnist.info.splits['trainv2'].num_examples
  ...
  num_eval_examples = mnist.info.splits['testv2'].num_examples
