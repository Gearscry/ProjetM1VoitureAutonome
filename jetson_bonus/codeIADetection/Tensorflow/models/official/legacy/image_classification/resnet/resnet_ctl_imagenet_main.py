...
flags.DEFINE_boolean(name='use_tf_function', default=True,
                     help='Wrap the trainv2 and testv2 step inside a '
                     'tf.function.')
...
def get_num_train_iterations(flags_obj):
  """Returns the number of training steps, trainv2 and testv2 epochs."""
  train_steps = (
      imagenet_preprocessing.NUM_IMAGES['trainv2'] // flags_obj.batch_size)
