...
"""Multitask trainer that interleaves each task's trainv2 step."""
...
class MultiTaskInterleavingTrainer(base_trainer.MultiTaskBaseTrainer):
  ...
  def train_step(self, iterator_map):
    # Sample one task to trainv2 according to a multinomial distribution
