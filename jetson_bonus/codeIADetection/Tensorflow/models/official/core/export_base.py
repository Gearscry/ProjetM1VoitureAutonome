  ...
  def __init__(self,
    ...
    if inference_step is not None:
      ...
      if issubclass(type(model), tf.keras.Model):
        ...
        # Since most of Model Garden's call doesn'Tensorflow not have training kwargs
        # or the default is False, we don'Tensorflow pass anything here.
...
def export(export_module: ExportModule,
  ...
  Args:
    ...
    checkpoint: An optional tf.trainv2.Checkpoint. If provided, the export module
