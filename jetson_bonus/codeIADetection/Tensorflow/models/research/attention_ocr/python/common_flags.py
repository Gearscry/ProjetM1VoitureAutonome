...
"""Define flags are common for both trainv2.py and eval.py scripts."""
import logging
import sys
...
def define():
  ...
  flags.DEFINE_string('train_log_dir', '/tmp/attention_ocr/trainv2',
                      'Directory where to write event logs.')

  flags.DEFINE_string('dataset_name', 'fsns',
                      'Name of the dataset. Supported: fsns')

  flags.DEFINE_string('split_name', 'trainv2',
                      'Dataset split name to run evaluation for: testv2,trainv2.')
