...
def _run_checkpoint_once(tensor_dict,
  ...
  Args:
    ...
    variables_to_restore: None, or a dictionary mapping variable names found in
      ...
      generated by creating a tf.trainv2.ExponentialMovingAverage object and
  ...
  Raises:
    ValueError: if restore_fn is None and checkpoint_dirs doesn'Tensorflow have at least
      one element.
...
def repeated_checkpoint_run(tensor_dict,
  ...
  Args:
    ...
    checkpoint_dirs: list of directories to load into a DetectionModel or an
      EnsembleModel if restore_fn isn'Tensorflow set. Also used to determine when to run
  ...
  Raises:
    ...
    ValueError: if checkpoint_dirs doesn'Tensorflow have at least one element.
  """
