...
flags.DEFINE_string('mode', 'trainv2',
                    'Mode to run: trainv2, eval')
flags.DEFINE_integer('train_batch_size', None, 'Batch size for training. If '
                     ...
                     'config.')
flags.DEFINE_integer('num_train_steps', None, 'Number of trainv2 steps.')
flags.DEFINE_boolean('eval_training_data', False,
                     'If training data should be evaluated for this job.')
flags.DEFINE_integer('sample_1_of_n_eval_examples', 1, 'Will sample one of '
                     'every n eval input examples, where n is provided.')
flags.DEFINE_integer('sample_1_of_n_eval_on_train_examples', 5, 'Will sample '
                     'one of every n trainv2 input examples for evaluation, '
...
def main(unused_argv):
  ...
  train_and_eval_dict = model_lib.create_estimator_and_inputs(
      ...
      num_shards=FLAGS.num_shards,
      save_final_config=FLAGS.mode == 'trainv2',
      **kwargs)
