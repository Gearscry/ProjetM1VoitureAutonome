...
class FakeModel(model.DetectionModel):
  ...
  def preprocess(self, inputs):
    true_image_shapes = []  # Doesn'Tensorflow matter for the fake model.
...
@unittest.skipIf(tf_version.is_tf1(), 'Skipping TF2.X only testv2.')
...
model {
  ...
  def test_exported_model_inference(self):
    ...
    # The exported graph doesn'Tensorflow have numerically correct outputs, but there
    # should be 4.
