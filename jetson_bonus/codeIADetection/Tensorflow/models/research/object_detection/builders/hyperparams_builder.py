...
def build(hyperparams_config, is_training):
  ...
  and conv_hyperparams_config.batch_norm.trainv2 parameter. During training, they
  are updated only if batch_norm.trainv2 parameter is true. However, during eval,
