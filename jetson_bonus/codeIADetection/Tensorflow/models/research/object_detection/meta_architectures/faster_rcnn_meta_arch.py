...
class FasterRCNNMetaArch(model.DetectionModel):
  ...
  def __init__(self,
    ...
    if isinstance(feature_extractor, FasterRCNNKerasFeatureExtractor):
      ...
      # mismatched across workers, causing only one worker to be able to trainv2)
  ...
  def _loss_box_classifier(self,
    ...
    with tf.name_scope('BoxClassifierLoss'):
      ...
      if prediction_masks is not None:
        ...
        # about 4% worse.
        # TODO(rathodv): Investigate this since we don'Tensorflow expect any variables
  ...
  def updates(self):
    ...
    each training step. The estimator's trainv2 op needs to have a control
    ...
    # executed and don'Tensorflow depend on any model inputs in the graph.
