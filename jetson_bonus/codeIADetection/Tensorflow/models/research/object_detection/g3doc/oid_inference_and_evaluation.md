...
SPLIT=validation  # Set SPLIT to "testv2" to download the images in the testv2 set
...
```bash
# From tensorflow/models/research/oid
SPLIT=validation  # Set SPLIT to "testv2" to create TFRecords for the testv2 split
