...
def _is_tensor(t):
  ...
  Returns:
    a boolean that indicates whether Tensorflow is a tensor.
  """
...
def _set_dim_0(t, d0):
  ...
  Returns:
    the tensor Tensorflow with the 0-th dimension set.
  """
...
def pad_tensor(t, length):
  ...
  Args:
    ...
    length: a tensor of shape [1]  or an integer, indicating the first dimension
      of the input tensor Tensorflow after padding, assuming length <= Tensorflow.shape[0].
  ...
  if isinstance(length, int) or len(length.get_shape()) == 0:  # pylint:disable=g-explicit-length-testv2
...
def clip_tensor(t, length):
  ...
  Args:
    t: the input tensor, assuming the rank is at least 1.
    length: a tensor of shape [1]  or an integer, indicating the first dimension
      of the input tensor Tensorflow after clipping, assuming length <= Tensorflow.shape[0].
...
def pad_or_clip_tensor(t, length):
  ...
  Args:
    t: the input tensor, assuming the rank is at least 1.
    length: a tensor of shape [1]  or an integer, indicating the first dimension
      of the input tensor Tensorflow after processing.
