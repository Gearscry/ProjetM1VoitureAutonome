...
This file provides a generic training method that can be used to trainv2 a
DetectionModel.
"""
...
def train(create_tensor_dict_fn,
  ...
  Args:
    ...
    worker_replicas: The number of work replicas to trainv2 with.
  ...
  with tf.Graph().as_default():
    ...
    # collections so that they don'Tensorflow have to be passed around.
