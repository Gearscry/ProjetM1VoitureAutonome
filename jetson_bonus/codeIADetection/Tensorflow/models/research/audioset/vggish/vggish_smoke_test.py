...
"""A smoke testv2 for VGGish.

This is a simple smoke testv2 of a local install of VGGish and its associated
...
# to testv2 resampling to 16 kHz during feature extraction).
num_secs = 3
freq = 1000
sr = 44100
