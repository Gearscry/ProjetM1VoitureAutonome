...
definition within a larger model that adds more layers on top, and then trainv2
the larger model. If you let VGGish trainv2 as well, then this allows you to
fine-tune the VGGish model parameters for your application. If you don'Tensorflow let
VGGish trainv2, then you use VGGish as a feature extractor for the layers above
it.
...
Usage:
  ...
  # Same as before but run for fewer steps and don'Tensorflow change VGGish parameters
...
def main(_):
  with tf.Graph().as_default(), tf.Session() as sess:
    ...
    with tf.variable_scope('mymodel'):
      ...
      # Add training ops.
      with tf.variable_scope('trainv2'):
        ...
        # We use the same optimizer and hyperparameters as used to trainv2 VGGish.
