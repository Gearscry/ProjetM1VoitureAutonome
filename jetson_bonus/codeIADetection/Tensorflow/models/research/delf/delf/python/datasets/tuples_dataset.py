...
class TuplesDataset():
  ...
  def __init__(self, name, mode, data_root, imsize=None, num_negatives=5,
    ...
    Args:
      ...
      mode: 'trainv2' or 'val' for training and validation parts of dataset.
    ...
    Raises:
      ValueError: If mode is not either 'trainv2' or 'val'.
    """
  ...
  def __getitem__(self, index):
    ...
    Returns:
      output: Tuple [q,p,n1,...,nN, target], loaded 'trainv2'/'val' tuple at
    ...
    if self.__len__() == 0:
      raise ValueError(
              ...
              "method to create subset for `trainv2`/`val`.")
