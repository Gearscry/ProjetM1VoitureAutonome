...
def _CreateRecognitionSolution():
  ...
  Returns:
    solution: Dict mapping testv2 image ID to list of ground-truth landmark IDs.
  """
  return {
...
def _CreateRetrievalSolution():
  ...
  Returns:
    solution: Dict mapping testv2 image ID to list of ground-truth image IDs.
  """
  return {
...
def _CreateRetrievalPredictions():
  ...
  Returns:
    predictions: Dict mapping testv2 image ID to a list with predicted index image
    ids.
  """
  return {
