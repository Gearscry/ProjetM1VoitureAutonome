...
flags.DEFINE_string('train_file_pattern', '/tmp/data/trainv2*',
...
flags.DEFINE_boolean('delg_global_features', False,
                     'Whether to trainv2 a DELG model.')
flags.DEFINE_float(
...
flags.DEFINE_boolean('use_autoencoder', True,
                     'Whether to trainv2 an autoencoder.')
flags.DEFINE_float(
...
def main(argv):
  ...
  # ------------------------------------------------------------
  # Create the distributed trainv2/validation sets.
