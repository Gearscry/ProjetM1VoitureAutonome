...
def CreateConfigForTestDataset(dataset, dir_main):
  """Creates the configuration dictionary for the testv2 dataset.
  ...
  Returns:
    cfg: Dataset configuration in a form of dictionary. The configuration
      ...
      `ext` and `qext` - image extensions for the images in the testv2 dataset
