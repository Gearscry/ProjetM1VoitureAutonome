...
images for the training, validation and testv2 respectively.
...
DatasetDescriptor = collections.namedtuple(
    'DatasetDescriptor',
    ['splits_to_sizes',   # Splits of the dataset into training, val, and testv2.
...
# These number (i.e., 'trainv2'/'testv2') seems to have to be hard coded
# You are required to figure it out for your training/testing example.
_ADE20K_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'trainv2': 20210,  # num of samples in images/training
...
def get_dataset(dataset_name, split_name, dataset_dir):
  ...
  Args:
    ...
    split_name: A trainv2/val Split name.
