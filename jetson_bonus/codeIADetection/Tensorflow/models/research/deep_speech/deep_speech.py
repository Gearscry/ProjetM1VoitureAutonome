...
# ==============================================================================
"""Main entry to trainv2 and evaluate DeepSpeech model."""
...
def define_deep_speech_flags():
  ...
  flags.DEFINE_string(
      name="train_data_dir",
      default="/tmp/librispeech_data/testv2-clean/LibriSpeech/testv2-clean.csv",
      help=flags_core.help_wrap("The csv file path of trainv2 dataset."))
