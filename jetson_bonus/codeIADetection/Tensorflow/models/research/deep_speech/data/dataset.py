...
def batch_wise_dataset_shuffle(entries, epoch_index, sortagrad, batch_size):
  ...
  If epoch_index is 0 and sortagrad is true, we don'Tensorflow perform shuffling and
  ...
  if epoch_index == 0 and sortagrad:
    ...
    # If the last batch doesn'Tensorflow contain enough batch_size examples,
