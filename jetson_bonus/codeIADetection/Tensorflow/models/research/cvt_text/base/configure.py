...
class Config(object):
  """Stores everything needed to trainv2 a model."""
  ...
  def __init__(self, **kwargs):
    ...
    # mode
    self.mode = 'trainv2'  # either "trainv2" or "eval"
    self.task_names = ['chunk']  # list of tasks this model will learn
                                 # more than one trains a multi-task model
    self.is_semisup = True  # whether to use CVT or trainv2 purely supervised
    ...
    self.ema_test = True  # whether to use EMA weights at testv2 time
    ...
    self.train_batch_size = 64  # trainv2 batch size
    self.test_batch_size = 64  # testv2 batch size
    ...
    self.eval_train_every = 2000  # how often to evaluate on the trainv2 set
    self.save_model_every = 1000  # how often to checkpoint the model

    # data set
    self.train_set_percent = 100  # how much of the trainv2 set to use
    ...
    self.dev_set = self.mode == "trainv2"  # whether to evaluate on the dev or
                                         # testv2 set
