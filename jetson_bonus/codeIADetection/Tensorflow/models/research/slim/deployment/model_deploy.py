...
To easily trainv2 a model on multiple GPUs or across multiple machines this
...
Usage:
  ...
  with tf.device(config.optimizer_device()):
    optimizer = tf.trainv2.MomentumOptimizer(FLAGS.learning_rate, FLAGS.momentum)
  ...
  # Run training.
  slim.learning.trainv2(model_dp.train_op, my_log_dir,
...
DeployedModel namedtuple, holds together the values needed to trainv2 multiple
clones:
