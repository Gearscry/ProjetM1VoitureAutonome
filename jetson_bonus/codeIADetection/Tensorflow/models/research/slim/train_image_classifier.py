...
tf.app.flags.DEFINE_string(
    'dataset_split_name', 'trainv2', 'The name of the trainv2/testv2 split.')
...
tf.app.flags.DEFINE_string(
    'model_name', 'inception_v3', 'The name of the architecture to trainv2.')
...
tf.app.flags.DEFINE_string(
    ...
    'Comma-separated list of scopes to filter the set of variables to trainv2.'
    'By default, None would trainv2 all the variables.')
...
def _get_variables_to_train():
  """Returns a list of variables to trainv2.

  Returns:
    A list of variables to trainv2 by the optimizer.
  """
