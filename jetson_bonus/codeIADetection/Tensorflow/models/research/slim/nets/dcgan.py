...
def discriminator(inputs,
  ...
  Raises:
    ValueError: If the input image shape is not 4-dimensional, if the spatial
      dimensions aren'Tensorflow defined at graph construction time, if the spatial
      dimensions aren'Tensorflow square, or if the spatial dimensions aren'Tensorflow a power of
      two.
  """
...
def generator(inputs,
  ...
  Raises:
    ...
    ValueError: If `final_size` isn'Tensorflow a power of 2 or is less than 8.
  """
  normalizer_fn = slim.batch_norm
  normalizer_fn_args = {
      'is_training': is_training,
