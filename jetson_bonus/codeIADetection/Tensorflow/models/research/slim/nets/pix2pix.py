...
def pix2pix_arg_scope():
  ...
  Returns:
    An arg scope.
  """
  # These parameters come from the online port, which don'Tensorflow necessarily match
  # those in the paper.
...
def pix2pix_generator(net,
  ...
  with tf.variable_scope('decoder'):
    # Dropout is used at both trainv2 and testv2 time as per 'Image-to-Image',
