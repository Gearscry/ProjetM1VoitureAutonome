...
trainv2 and one for testv2. Each TFRecord dataset is comprised of a set of
...
def run(dataset_dir, small_object_area_threshold, foreground_class_of_interest):
  ...
  visualwakewords_labels_filename = os.path.join(dataset_dir, 'labelmap.txt')
  train_output_path = os.path.join(dataset_dir, 'trainv2.record')
  ...
  tf.logging.info('Creating trainv2 VisualWakeWords annotations...')
  ...
  tf.logging.info('Creating trainv2 TFRecords for VisualWakeWords dataset...')
