...
WARNING: Don'Tensorflow use for object detection, in this case all the bounding boxes
...
# by reading them from labelmap.txt or github.
...
def get_split(split_name, dataset_dir, file_pattern=None, reader=None):
  ...
  Args:
    split_name: A trainv2/testv2 split name.
  ...
  Raises:
    ValueError: if `split_name` is not a valid trainv2/testv2 split.
  """
