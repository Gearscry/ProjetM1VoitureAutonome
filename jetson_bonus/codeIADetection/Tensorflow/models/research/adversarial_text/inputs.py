...
def _filenames_for_data_spec(phase, bidir, pretrain, use_seq2seq):
  ...
  Args:
    phase: str, 'trainv2', 'testv2', or 'valid'.
  ...
  data_specs = {
      ('trainv2', True, True, False): (data_utils.TRAIN_LM,
                                     data_utils.TRAIN_REV_LM),
      ('trainv2', True, False, False): (data_utils.TRAIN_BD_CLASS,),
      ('trainv2', False, True, False): (data_utils.TRAIN_LM,),
      ('trainv2', False, True, True): (data_utils.TRAIN_SA,),
      ('trainv2', False, False, False): (data_utils.TRAIN_CLASS,),
      ('testv2', True, True, False): (data_utils.TEST_LM,
                                    data_utils.TRAIN_REV_LM),
      ('testv2', True, False, False): (data_utils.TEST_BD_CLASS,),
      ('testv2', False, True, False): (data_utils.TEST_LM,),
      ('testv2', False, True, True): (data_utils.TEST_SA,),
      ('testv2', False, False, False): (data_utils.TEST_CLASS,),
...
def inputs(data_dir=None,
  ...
  Args:
    data_dir: str, directory containing TFRecord files of SequenceExample.
    phase: str, dataset for evaluation {'trainv2', 'valid', 'testv2'}.
