...
flags.DEFINE_float("train_percentage", 4.0/5.0,
                   "Percentage of trainv2 vs validation trials")
...
for n in range(ndatasets):
  ...
  if FLAGS.noise_type == "poisson":
    ...
    # split into trainv2 and validation sets
  train_inds, valid_inds = get_train_n_valid_inds(E, train_percentage,
                                                  nreplications)

  # Split the data, inputs, labels and times into trainv2 vs. validation.
...
if S < N:
  # Note that this isn'Tensorflow necessary for this synthetic example, but
