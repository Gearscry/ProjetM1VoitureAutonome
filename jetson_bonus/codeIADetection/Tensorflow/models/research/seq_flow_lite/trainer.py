...
# ==============================================================================
# Lint as: python3
"""A utility for PRADO model to do trainv2, eval, inference and model export."""
...
flags.DEFINE_enum("runner_mode", None, ["trainv2", "train_and_eval", "eval"],
                  "Runner mode.")
