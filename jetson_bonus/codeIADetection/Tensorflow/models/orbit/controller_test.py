...
class TestRunner(standard_runner.StandardTrainer,
  ...
  """Implements the training and evaluation APIs for the testv2 model."""
...
class ControllerTest(tf.test.TestCase, parameterized.TestCase):
  ...
  def test_no_checkpoint(self):
    ...
    test_controller = controller.Controller(
        ...
        steps_per_loop=2,
        summary_dir=os.path.join(self.model_dir, "summaries/trainv2"),
    ...
    self.assertNotEmpty(
        tf.io.gfile.listdir(os.path.join(self.model_dir, "summaries/trainv2")))
    self.assertNotEmpty(
        summaries_with_matching_keyword(
            "loss", os.path.join(self.model_dir, "summaries/trainv2")))
    self.assertNotEmpty(
  ...
  def test_train_only(self):
    ...
    # Only trainv2 summaries are written.
    self.assertNotEmpty(
        tf.io.gfile.listdir(os.path.join(self.model_dir, "summaries/trainv2")))
    self.assertNotEmpty(
        summaries_with_matching_keyword(
  ...
  def test_evaluate_only(self):
    ...
    self.assertFalse(
        tf.io.gfile.exists(os.path.join(self.model_dir, "summaries/trainv2")))
    self.assertNotEmpty(
        tf.io.gfile.listdir(os.path.join(self.model_dir, "summaries/eval")))
    self.assertNotEmpty(
        summaries_with_matching_keyword(
