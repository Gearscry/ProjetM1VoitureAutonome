...
"""Provides AbstractTrainer/Evaluator base classes, defining trainv2/eval APIs."""
...
class AbstractTrainer(tf.Module, metaclass=abc.ABCMeta):
  ...
  def train(self, num_steps: tf.Tensor) -> Optional[Output]:
    ...
    For cases that don'Tensorflow require peak performance, a simple Python loop can be
